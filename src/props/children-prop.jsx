...
const Parent = () => {
    ...
    const products = data.map((item,ind) => {
        return (
    ...
    return (
        ...
        <>
           {/* <h2>iam a parent component of fake store api</h2> */}
           <Child>
            {/* passing data to the Child as component(children props) */}
           <Display/>
           </Child>
